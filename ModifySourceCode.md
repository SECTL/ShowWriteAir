...
# 1. 开始
## 1.1 获取源代码
打开项目地址 https://github.com/wwcrdrvf6u/ShowWriteAir/ 
...
此时你的浏览器会开始下载。请在下载完成后点击**打开文件夹**，以打开压缩包所在的目录，右键单击此文件，会显示快捷菜单，此时点击**解压到ShowWriteAir-main/**（注：showwrite-main是刚刚下载的文件的文件名）。

<img width="383" height="149" alt="image" src="https://github.com/user-attachments/assets/f387e017-c987-4a34-b69f-36a7410bfb7e" />

将文件解压缩到目录中，完成之后，双击解压完成的文件夹ShowWriteAir-main，来到子目录，并再次双击子目录下的文件夹ShowWriteAir-main，并再次双击Main文件夹。打开源代码目录，您应该会看到一些文件（如图）。
